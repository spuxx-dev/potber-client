export const listTagMocks: ContentParserMock[] = [
  ...
  },
  {
    ...
    expected:
      ...
      '<li><a href="https://github.com/spuxx-dev/potber-api/blob/develop/README.md" target="_blank">Dokumentation</a></li>' +
      '<li><a href="https://github.com/spuxx-dev/potber-api/blob/develop/CHANGELOG.md" target="_blank">Changelog</a></li>' +
      '<li><a href="https://github.com/spuxx-dev/potber-api/issues" target="_blank">GitHub Issues</a> - Bugs & Feature requests</li>' +
      '<li><a href="https://github.com/spuxx-dev/potber-api" target="_blank">GitHub Repository</a></li>' +
