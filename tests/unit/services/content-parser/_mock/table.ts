export const tableTagMocks: ContentParserMock[] = [
  ...
  },
  {
    ...
    [/table]`,
    expected: `<table><tr><td>Ameisenfutter</td><td>JS & Web-Kram (<a href="https://github.com/spuxx-dev" target="_blank">GitHub</a>)</td></tr><tr><td>anoX*</td><td>so ziemlich alles (und ABAP, lel)</td></tr><tr><td>Atomsk</td><td>TSQL, DAX, C#</td></tr></table>`,
  },
  {
